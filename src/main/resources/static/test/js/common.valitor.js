...
JsCore.Valitor = {
    ...
    "Mobile": { "v": /^((0\d{2,3}\d{6,15})|(1[35678]{1}\d{9}))$/, "msg": "请输入手机号码(纯数字)" },
    "Money": { "v": /^(([1-9](\d+)?)|0)(\.\d+)?$/, "msg": "请输入金额" },
    "Numeral": { "v": /^\d+$/, "msg": "请输入数字" },
    "-1OrNumeral": { "v": /^\-1$|^[1-9]{1}[0-9]{0,}$/, "msg": "请输入正确格式的数字" },
    "NumberalPlusp": { "v": /^[1-9]{1}[0-9]{0,}$/, "msg": "请输入正确格式的数字" },
    ...
    "Password": { "v": "this._Password(value)", "msg": "密码必须是6-20位字母和数字的组合，并且不能包含特殊字符" },
